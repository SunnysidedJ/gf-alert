...
```bash
launchctl unload ~/Library/LaunchAgents/com.jaeheelee.gf-alert.plist
launchctl load ~/Library/LaunchAgents/com.jaeheelee.gf-alert.plist
```
...
```bash
launchctl unload ~/Library/LaunchAgents/com.jaeheelee.gf-alert.plist
rm ~/Library/LaunchAgents/com.jaeheelee.gf-alert.plist
